...
public class DataMsg extends netTest.serial.SerializableMessage {
    ...
    /** Create a new DataMsg of size 48. */
    public DataMsg() {
    ...
    public String toString() {
      ...
      try {
        ...
        for (int i = 0; i < 3; i++) {
          s += "0x"+Long.toHexString(getElement_routing_data_parents_addr(i) & 0xff)+" ";
        }
        s += "]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      try {
        ...
        for (int i = 0; i < 3; i++) {
          s += "0x"+Long.toHexString(getElement_routing_data_parents_etx(i) & 0xff)+" ";
        }
        s += "]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      try {
        ...
        for (int i = 0; i < 3; i++) {
          s += "0x"+Long.toHexString(getElement_routing_data_parents_periods(i) & 0xff)+" ";
        }
        s += "]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      try {
        ...
        for (int i = 0; i < 3; i++) {
          s += "0x"+Long.toHexString(getElement_routing_data_parents_subunits(i) & 0xff)+" ";
        }
        s += "]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      return s;
